    ...
    public partial class inital : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Lauro", "Sanches" });

            migrationBuilder.InsertData(
                table: "Professores",
                columns: new[] { "Id", "Nome", "Sobrenome" },
                values: new object[] { 2, "Roberto", "Silva" });

            migrationBuilder.InsertData(
                table: "Professores",
                columns: new[] { "Id", "Nome", "Sobrenome" },
                values: new object[] { 3, "Ronaldo", "Santos" });

            migrationBuilder.InsertData(
                table: "Professores",
                columns: new[] { "Id", "Nome", "Sobrenome" },
                values: new object[] { 4, "Rodrigo", "Pinheiro" });

            migrationBuilder.InsertData(
                table: "Professores",
                columns: new[] { "Id", "Nome", "Sobrenome" },
                values: new object[] { 5, "Alexandre", "Pereira" });
