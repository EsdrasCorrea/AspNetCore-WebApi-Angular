        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Professor>()
                .HasData(new List<Professor>(){
                    new Professor(1, "Lauro", "Sanches"),
                    new Professor(2, "Roberto", "Silva"),
                    new Professor(3, "Ronaldo", "Santos"),
                    new Professor(4, "Rodrigo", "Pinheiro"),
                    new Professor(5, "Alexandre", "Pereira"),
                });
